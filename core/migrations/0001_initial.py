# Generated by Django 4.1.5 on 2023-06-24 13:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='mantencion',
            fields=[
                ('id_mant', models.IntegerField(primary_key=True, serialize=False, verbose_name='Id mantencion')),
                ('desc_mantencion', models.CharField(max_length=50, verbose_name='descuento')),
                ('fecha_mant', models.DateTimeField()),
                ('id_patente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.vehiculo')),
            ],
        ),
    ]
